...
Shader "RedDotGames/Mobile/Car Paint Medium Detail Alpha" {
   Properties {
...
void main ()
{
  ...
  color = ((tmpvar_17 + reflTex) + (tmpvar_16 * reflTex));
  color.w = _Color.w;
  gl_FragData[0] = color;
}
...
MUL R5.xyz, R2.w, c[2];
ABS R1.w, R1;
CMP R2.w, -R1, c[11].z, c[11].y;
MUL R4.xyz, R0.w, R4;
CMP R4.xyz, -R2.w, R4, R5;
DP3 R1.w, R2, R4;
MUL R2.xyz, R2, -R1.w;
CMP R0.w, -R2, R0, c[11].y;
SLT R2.w, R1, c[11].z;
RSQ R3.w, R3.w;
...
MAX R2.x, R2, c[11].z;
POW R3.w, R2.x, c[6].x;
MUL R2.xyz, R0.w, c[10];
MUL R4.xyz, R2, c[5];
ABS R0.w, R2;
CMP R2.w, -R0, c[11].z, c[11].y;
...
CMP R3.xyz, -R2.w, R4, c[11].z;
MOV R4.xyz, c[3];
MAD R4.xyz, R4, c[0], fragment.texcoord[2];
MAD_SAT R2.xyz, R2, R1.w, R4;
MUL R3.xyz, R3, c[7].x;
...
abs_pp r6.x, r1
abs_pp_sat r1.x, r3
cmp_pp r3.xyz, -r6.x, r8, c11.z
add_pp r1.x, -r1, c11.y
mul_pp r6.xyz, r3, c7.x
...
texld r5, r7, s1
mov_pp r7.xyz, c0
mad_pp r3.xyz, c3, r7, t2
mad_pp_sat r1.xyz, r2, r1.x, r3
