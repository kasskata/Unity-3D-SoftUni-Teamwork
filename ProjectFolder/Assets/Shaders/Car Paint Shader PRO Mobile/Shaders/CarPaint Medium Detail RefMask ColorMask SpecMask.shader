...
Shader "RedDotGames/Mobile/Car Paint Medium Detail Ref Color Spec Mask" {
   Properties {
...
void main ()
{
  ...
  xlv_TEXCOORD1 = normalize ((tmpvar_3 * modelMatrixInverse).xyz);
...
void main ()
{
  ...
  lowp vec4 tmpvar_16;
  tmpvar_16.w = 1.0;
  tmpvar_16.xyz = (((tmpvar_3.xyz * mix (_Color.xyz, vec3(1.0, 1.0, 1.0), vec3((1.0 - tmpvar_3.w)))) * clamp (((xlv_TEXCOORD2 + ambientLighting) + tmpvar_6), 0.0, 1.0)) + specularReflection);
  gl_FragData[0] = ((tmpvar_16 + (reflTex * tmpvar_3.w)) + ((tmpvar_15 * reflTex) * tmpvar_3.w));
}
...
"vs_2_0
; 51 ALU
def c19, 0.00000000, 1.00000000, 0, 0
dcl_position0 v0
dcl_normal0 v1
dcl_texcoord0 v2
mul r0.xyz, v1.y, c9
...
void main ()
{
  ...
  modelMatrixInverse = (_World2Object);
  lowp vec4 tmpvar_4;
  tmpvar_4 = (modelMatrix * _glesVertex);
  lowp vec4 tmpvar_5;
  tmpvar_5.w = 0.0;
  tmpvar_5.xyz = normalize (_glesNormal);
  lowp vec3 tmpvar_6;
  tmpvar_6 = normalize ((tmpvar_5 * modelMatrixInverse).xyz);
  highp vec4 tmpvar_7;
  ...
  highp vec3 tmpvar_9;
  tmpvar_9 = normalize (((modelMatrix * _glesVertex) - tmpvar_8).xyz);
  tmpvar_3 = tmpvar_9;
  ...
  lightPosition = tmpvar_10;
  lowp vec3 tmpvar_11;
  tmpvar_11 = (lightPosition - tmpvar_4).xyz;
  lowp float tmpvar_12;
  tmpvar_12 = dot (tmpvar_11, tmpvar_11);
  highp float tmpvar_13;
  tmpvar_13 = (1.0/((1.0 + (unity_4LightAtten0.x * tmpvar_12))));
  attenuation = tmpvar_13;
  lowp float tmpvar_14;
  tmpvar_14 = max (0.0, dot (tmpvar_6, normalize (tmpvar_11)));
  highp vec3 tmpvar_15;
  tmpvar_15 = ((attenuation * unity_LightColor[0].xyz) * tmpvar_14);
  diffuseReflection = tmpvar_15;
  tmpvar_2 = diffuseReflection;
  highp vec4 tmpvar_16;
  tmpvar_16.w = 1.0;
  tmpvar_16.x = unity_4LightPosX0.y;
  tmpvar_16.y = unity_4LightPosY0.y;
  tmpvar_16.z = unity_4LightPosZ0.y;
  lightPosition = tmpvar_16;
  lowp vec3 tmpvar_17;
  tmpvar_17 = (lightPosition - tmpvar_4).xyz;
  lowp float tmpvar_18;
  tmpvar_18 = dot (tmpvar_17, tmpvar_17);
  highp float tmpvar_19;
  tmpvar_19 = (1.0/((1.0 + (unity_4LightAtten0.y * tmpvar_18))));
  attenuation = tmpvar_19;
  lowp float tmpvar_20;
  tmpvar_20 = max (0.0, dot (tmpvar_6, normalize (tmpvar_17)));
  highp vec3 tmpvar_21;
  tmpvar_21 = ((attenuation * unity_LightColor[1].xyz) * tmpvar_20);
...
abaaaaaaabaaahacabaaaakeacaaaaaabdaaaaaaabaaaaaa add r1.xyz, r1.xyzz, c19.x
...
adaaaaaaabaaaiacaaaaaappacaaaaaabaaaaaffabaaaaaa mul r1.w, r0.w, c16.y
ahaaaaaaaaaaaiacacaaaaaaacaaaaaabdaaaaaaabaaaaaa max r0.w, r2.x, c19.x
abaaaaaaabaaaiacabaaaappacaaaaaabdaaaaffabaaaaaa add r1.w, r1.w, c19.y
...
afaaaaaaacaaabacabaaaappacaaaaaaaaaaaaaaaaaaaaaa rcp r2.x, r1.w
...
adaaaaaaacaaahacacaaaaaaacaaaaaabcaaaaoeabaaaaaa mul r2.xyz, r2.x, c18
...
abaaaaaaaaaaaiacaaaaaappacaaaaaabdaaaaffabaaaaaa add r0.w, r0.w, c19.y
...
ahaaaaaaabaaaiacabaaaappacaaaaaabdaaaaaaabaaaaaa max r1.w, r1.w, c19.x
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 60 to 60, TEX: 2 to 2
...
MUL R4.xyz, R4, R5.x;
CMP R4.xyz, -R3.w, R4, c[11].z;
MUL R4.w, R1, c[7].x;
MUL R4.xyz, R4, R4.w;
DP3 R4.w, R3, fragment.texcoord[1];
MOV R3.w, c[11].y;
TEX R0, R3, texture[1], CUBE;
ADD R3.xyz, R3.w, -c[3];
ADD R3.w, -R1, c[11].y;
MAD R3.xyz, R3.w, R3, c[3];
ABS_SAT R3.w, R4;
MUL R1.xyz, R1, R3;
...
POW R2.w, R3.x, c[9].x;
MUL R3.w, R2, c[8].x;
ADD_SAT R2.w, R3, c[4].x;
MUL R0.xyz, R0, R2.w;
ADD R3.xyz, fragment.texcoord[2], c[0];
MAD_SAT R2.xyz, R2, R4.w, R3;
MAD R2.xyz, R1, R2, R4;
MOV R2.w, c[11].y;
MAD R2, R0, R1.w, R2;
MUL R0, R3.w, R0;
...
rsq r3.x, r3.x
mul r3.xyz, r3.x, r8
mad_pp r7.xyz, -r7, c11.x, -r9
dp3_pp r3.x, r7, r3
max_pp r3.x, r3, c11.z
pow_pp r7.w, r3.x, c6.x
cmp_pp r1.x, -r2, r1, c11.y
mul_pp r3.xyz, r1.x, c10
mov_pp r1.x, r7.w
mul_pp r2.xyz, r3, c5
mul_pp r7.xyz, r2, r1.x
cmp_pp r1.x, r0, c11.z, c11.y
abs_pp r2.x, r1
cmp_pp r2.xyz, -r2.x, r7, c11.z
mul_pp r1.x, r5.w, c7
mul_pp r7.xyz, r2, r1.x
dp3_pp r1.x, r6, t1
abs_pp_sat r1.x, r1
...
texld r4, r6, s1
add_pp r6.xyz, c11.y, -r2
add_pp r2.x, -r5.w, c11.y
mad_pp r2.xyz, r2.x, r6, c3
mul_pp r5.xyz, r5, r2
pow_pp r2.x, r1.x, c9.x
max_pp r1.x, r0, c11.z
mov_pp r0.x, r2.x
add_pp r6.xyz, t2, c0
mad_pp_sat r1.xyz, r3, r1.x, r6
...
mov_pp r1.w, r4
mov_pp r2.w, c11.y
mad_pp r2, r1, r5.w, r2
mul_pp r0, r0.x, r1
mad_pp r0, r0, r5.w, r2
mov_pp oC0, r0
"
}
