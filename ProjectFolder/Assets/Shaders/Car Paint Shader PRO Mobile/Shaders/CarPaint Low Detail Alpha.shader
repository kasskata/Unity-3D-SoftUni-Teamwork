...
Shader "RedDotGames/Mobile/Car Paint Low Detail Alpha" {
   Properties {
...
void main ()
{
  ...
  lowp vec4 tmpvar_17;
  tmpvar_17.xyz = ((((tmpvar_4.xyz * clamp ((ambientLighting + tmpvar_7), 0.0, 1.0)) + specularReflection) + reflTex.xyz) + (tmpvar_16 * reflTex).xyz);
  tmpvar_17.w = _Color.w;
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 45 to 45, TEX: 2 to 2
...
CMP R2.xyz, -R2.w, R2, c[11].z;
MUL R1.w, R1, c[8].x;
MAX R0.w, R0, c[11].z;
MOV result.color.w, c[3];
TEX R0.xyz, R4, texture[1], CUBE;
TEX R1.xyz, fragment.texcoord[3], texture[0], 2D;
MUL R4.xyz, R2, c[7].x;
MOV R2.xyz, c[3];
MUL R3.xyz, R2, c[10];
MUL R3.xyz, R3, R0.w;
ADD_SAT R0.w, R1, c[4].x;
MAD_SAT R2.xyz, R2, c[0], R3;
MUL R0.xyz, R0, R0.w;
MAD R1.xyz, R1, R2, R4;
ADD R1.xyz, R0, R1;
...
mad_pp r5.xyz, -r0, c11.x, -r4
dp3_pp r0.x, c2, c2
rsq_pp r0.x, r0.x
mul_pp r6.xyz, r0.x, c2
dp3_pp r0.x, r1, r6
mul_pp r1.xyz, r1, -r0.x
mad_pp r6.xyz, -r1, c11.x, -r6
dp3_pp r4.x, r4, r6
dp3_pp r1.x, r5, t1
abs_pp_sat r1.x, r1
add_pp r1.x, -r1, c11.y
pow_pp r6.x, r1.x, c9.x
cmp_pp r1.x, r0, c11.z, c11.y
max_pp r4.x, r4, c11.z
abs_pp r1.x, r1
max_pp r0.x, r0, c11.z
mov_pp r0.w, c3
texld r3, r5, s1
texld r2, t3, s0
pow_pp r5.w, r4.x, c6.x
mov_pp r4.x, r5.w
mov_pp r5.xyz, c10
mul_pp r5.xyz, c5, r5
mul_pp r4.xyz, r5, r4.x
cmp_pp r4.xyz, -r1.x, r4, c11.z
mov_pp r1.x, r6.x
mov_pp r5.xyz, c10
mul_pp r5.xyz, c3, r5
mul_pp r5.xyz, r5, r0.x
mov_pp r0.xyz, c0
mad_pp_sat r0.xyz, c3, r0, r5
mul_pp r1.x, r1, c8
