...
void main ()
{
  ...
  highp vec3 tmpvar_8;
  tmpvar_8 = normalize (((modelMatrix * _glesVertex) - tmpvar_7).xyz);
  tmpvar_3 = tmpvar_8;
  lowp vec4 tmpvar_9;
  tmpvar_9.w = 1.0;
  ...
  tmpvar_20 = (shl * _SHLightingScale);
  tmpvar_2 = tmpvar_20;
...
void main ()
{
  ...
  tmpvar_15 = (((attenuation * unity_LightColor[0].xyz) * _Color.xyz) * tmpvar_14);
  ...
  tmpvar_21 = (((attenuation * unity_LightColor[1].xyz) * _Color.xyz) * tmpvar_20);
  diffuseReflection = tmpvar_21;
  tmpvar_2 = (tmpvar_2 + diffuseReflection);
  highp vec4 tmpvar_22;
  tmpvar_22.w = 1.0;
  tmpvar_22.x = unity_4LightPosX0.z;
  tmpvar_22.y = unity_4LightPosY0.z;
  tmpvar_22.z = unity_4LightPosZ0.z;
  lightPosition = tmpvar_22;
  lowp vec3 tmpvar_23;
  tmpvar_23 = (lightPosition - tmpvar_4).xyz;
  lowp float tmpvar_24;
  tmpvar_24 = dot (tmpvar_23, tmpvar_23);
  highp float tmpvar_25;
  tmpvar_25 = (1.0/((1.0 + (unity_4LightAtten0.z * tmpvar_24))));
  attenuation = tmpvar_25;
  lowp float tmpvar_26;
  tmpvar_26 = max (0.0, dot (tmpvar_6, normalize (tmpvar_23)));
  highp vec3 tmpvar_27;
  tmpvar_27 = (((attenuation * unity_LightColor[2].xyz) * _Color.xyz) * tmpvar_26);
  diffuseReflection = tmpvar_27;
  tmpvar_2 = (tmpvar_2 + diffuseReflection);
  highp vec4 tmpvar_28;
  tmpvar_28.w = 1.0;
  tmpvar_28.x = unity_4LightPosX0.w;
  tmpvar_28.y = unity_4LightPosY0.w;
  tmpvar_28.z = unity_4LightPosZ0.w;
  lightPosition = tmpvar_28;
  lowp vec3 tmpvar_29;
  tmpvar_29 = (lightPosition - tmpvar_4).xyz;
  lowp float tmpvar_30;
  tmpvar_30 = dot (tmpvar_29, tmpvar_29);
  highp float tmpvar_31;
  tmpvar_31 = (1.0/((1.0 + (unity_4LightAtten0.w * tmpvar_30))));
  attenuation = tmpvar_31;
  lowp float tmpvar_32;
  tmpvar_32 = max (0.0, dot (tmpvar_6, normalize (tmpvar_29)));
  highp vec3 tmpvar_33;
  tmpvar_33 = (((attenuation * unity_LightColor[3].xyz) * _Color.xyz) * tmpvar_32);
  ...
  tmpvar_36 = dot (unity_SHAr, normal);
  x1.x = tmpvar_36;
  highp float tmpvar_37;
  tmpvar_37 = dot (unity_SHAg, normal);
  x1.y = tmpvar_37;
  highp float tmpvar_38;
  tmpvar_38 = dot (unity_SHAb, normal);
  x1.z = tmpvar_38;
  mediump vec4 tmpvar_39;
  tmpvar_39 = (normal.xyzz * normal.yzzx);
  ...
  tmpvar_43 = ((normal.x * normal.x) - (normal.y * normal.y));
  vC = tmpvar_43;
  highp vec3 tmpvar_44;
  tmpvar_44 = (unity_SHC.xyz * vC);
  x3 = tmpvar_44;
  tmpvar_35 = ((x1 + x2) + x3);
  shl = tmpvar_35;
  highp vec3 tmpvar_45;
  tmpvar_45 = (tmpvar_2 + (shl * _SHLightingScale));
  tmpvar_2 = tmpvar_45;
  gl_Position = tmpvar_1;
