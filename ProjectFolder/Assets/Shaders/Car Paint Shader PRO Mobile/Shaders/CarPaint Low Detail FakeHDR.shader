...
void main ()
{
  ...
  lowp vec3 tmpvar_7;
  tmpvar_7 = ((_LightColor0.xyz * _Color.xyz) * max (0.0, dot (tmpvar_1, tmpvar_5)));
  lowp float tmpvar_8;
  ...
  lowp vec4 tmpvar_17;
  tmpvar_17.w = 1.0;
  tmpvar_17.xyz = (((((tmpvar_4.xyz * clamp ((ambientLighting + tmpvar_7), 0.0, 1.0)) + ((((clamp ((1.0 - tmpvar_7), 0.0, 1.0) * _hdrInt) + (reflTex * _hdrInt).xyz) + ((tmpvar_16 * reflTex) * _hdrInt).xyz) * _Color.xyz)) + specularReflection) + reflTex.xyz) + (tmpvar_16 * reflTex).xyz);
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 51 to 51, TEX: 2 to 2
...
MUL R6.xyz, R5, c[11];
MOV result.color.w, c[12].y;
TEX R1.xyz, R2, texture[1], CUBE;
...
MUL R7.xyz, R0.w, R1;
MUL R9.xyz, R1, c[8].x;
ADD_SAT R8.xyz, -R6, c[12].y;
MAD R8.xyz, R8, c[8].x, R9;
MAD R4.xyz, R7, c[8].x, R8;
MUL R2.xyz, R4, c[3];
MAD_SAT R3.xyz, R5, c[0], R6;
MAD R0.xyz, R0, R3, R2;
MOV R2.xyz, c[5];
POW R2.w, R2.w, c[6].x;
MUL R2.xyz, R2, c[11];
...
rsq_pp r0.x, r0.x
mul r6.xyz, r1.x, r2
mul_pp r5.xyz, r0.x, t1
dp3_pp r0.x, r5, -r6
mul_pp r0.xyz, r5, r0.x
mad_pp r0.xyz, -r0, c12.x, -r6
mov_pp r0.w, c12.y
texld r3, r0, s1
dp3_pp r0.x, r0, t1
abs_pp_sat r0.x, r0
add_pp r0.x, -r0, c12.y
pow_pp r1.w, r0.x, c10.x
dp3_pp r0.x, c2, c2
rsq_pp r2.x, r0.x
mul_pp r0.x, r1.w, c9
mul_pp r7.xyz, r2.x, c2
add_pp_sat r2.x, r0, c4
mul_pp r8.xyz, r3, r2.x
dp3_pp r1.x, r5, r7
mul_pp r2.xyz, r5, -r1.x
mad_pp r2.xyz, -r2, c12.x, -r7
dp3_pp r3.x, r6, r2
max_pp r2.x, r1, c12.z
mov_pp r6.xyz, c11
mul_pp r6.xyz, c3, r6
mad_pp_sat r9.xyz, -r6, r2.x, c12.y
mul_pp r6.xyz, r6, r2.x
mul_pp r7.xyz, r8, c8.x
mov_pp r2.xyz, c0
cmp_pp r1.x, r1, c12.z, c12.y
mad_pp_sat r2.xyz, c3, r2, r6
mul_pp r5.xyz, r0.x, r8
mad_pp r7.xyz, r9, c8.x, r7
max_pp r3.x, r3, c12.z
mad_pp r7.xyz, r5, c8.x, r7
pow_pp r5.x, r3.x, c6.x
mul_pp r3.xyz, r7, c3
...
abs_pp r1.x, r1
cmp_pp r1.xyz, -r1.x, r2, c12.z
mad_pp r1.xyz, r1, c7.x, r3
add_pp r1.xyz, r8, r1
mad_pp r0.xyz, r0.x, r8, r1
mov_pp oC0, r0
"
}
