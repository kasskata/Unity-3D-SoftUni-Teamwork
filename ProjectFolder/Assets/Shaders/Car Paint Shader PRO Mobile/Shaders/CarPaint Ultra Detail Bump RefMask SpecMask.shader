...
void main ()
{
  ...
  tmpvar_13 = (specularReflection * (_Gloss * tmpvar_7.w));
  ...
  tmpvar_26 = (tmpvar_25 + ((paintColor * _FlakePower) * tmpvar_7.w));
  color = tmpvar_26;
  color = ((color + (reflTex * tmpvar_7.w)) + ((tmpvar_24 * reflTex) * tmpvar_7.w));
  color.w = 1.0;
  gl_FragData[0] = color;
}
...
void main ()
{
  ...
  tmpvar_14 = (specularReflection * (_Gloss * tmpvar_7.w));
  ...
  tmpvar_28 = (tmpvar_27 + ((tmpvar_21 * _FlakePower) * tmpvar_7.w));
  color = tmpvar_28;
  color = ((color + (reflTex * tmpvar_7.w)) + ((tmpvar_26 * reflTex) * tmpvar_7.w));
  color.w = 1.0;
  gl_FragData[0] = color;
}
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 96 to 99, TEX: 4 to 5
//   d3d9 - ALU: 97 to 98, TEX: 4 to 5
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
...
MUL R2.xyz, R1.y, R0;
MAD R3.xyz, R1.x, fragment.texcoord[6], R2;
MAD R1.xyz, R1.z, fragment.texcoord[5], R3;
...
MUL R2.xyz, R2, c[15];
MUL R2.xyz, R2, R2.w;
CMP R0.w, -R0, c[16], c[16].x;
CMP R3.xyz, -R0.w, R2, c[16].w;
MOV R2.y, R0.z;
...
mad_pp r2.xyz, r0.x, v6, r2
mad_pp r2.xyz, r0.z, v5, r2
add r0.xyz, -v0, c2
dp3_pp r1.w, r0, r0
dp3_pp r0.w, r2, r2
rsq_pp r0.w, r0.w
...
max_pp r2.w, r0, c17
pow_pp r0, r2.w, c7.x
cmp r0.y, r1.w, c18.x, c18
abs_pp r2.w, r0.y
mov_pp r3.w, r0.x
mul_pp r3.xyz, c6, r3
mul_pp r3.xyz, r3, r3.w
texld r0, v3, s1
cmp_pp r3.xyz, -r2.w, r3, c17.w
mul_pp r3.w, r0, c8.x
...
MAD R1.xy, fragment.texcoord[3], c[3], c[3].zwzw;
TEX R1.xyz, R1, texture[0], 2D;
MAD R3.xyz, R1, c[16].y, -c[16].x;
MUL R1.xyz, R3.y, R0;
MAD R1.xyz, R3.x, fragment.texcoord[6], R1;
MAD R1.xyz, R3.z, fragment.texcoord[5], R1;
DP3 R2.w, R1, R1;
RSQ R0.w, R2.w;
ABS R2.w, -c[2];
DP3 R1.w, c[2], c[2];
RSQ R1.w, R1.w;
CMP R2.w, -R2, c[16], c[16].x;
MUL R1.xyz, R0.w, R1;
MUL R3.xyz, R1.w, c[2];
ABS R2.w, R2;
CMP R1.w, -R2, c[16], c[16].x;
CMP R2.xyz, -R1.w, R2, R3;
DP3 R1.w, R1, R2;
SLT R0.w, R1, c[16];
DP3 R3.w, R1, -R2;
...
mad_pp r1.xyz, r0, c16.x, c16.y
mul_pp r0.xyz, r1.y, r2
mad_pp r0.xyz, r1.x, v6, r0
mad_pp r1.xyz, r1.z, v5, r0
dp3_pp r0.w, r1, r1
rsq_pp r1.w, r0.w
...
mul r0.xyz, r0.w, r0
dp3_pp r0.x, r4, r0
max_pp r2.w, r0.x, c17
cmp r3.x, r1.w, c18, c18.y
pow_pp r0, r2.w, c7.x
texldp r4.x, v7, s2
mov_pp r3.w, r0.x
...
mul_pp r5.xy, r4.zwzw, c16.w
texld r5.xyz, r5, s3
mad_pp r5.xyz, r5, c17.x, c17.yyzw
mov r1.x, v6.z
mov r1.z, v5
dp3_pp r1.z, r1, -r5
mov r2.w, v5.y
