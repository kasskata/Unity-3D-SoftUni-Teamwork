...
Shader "RedDotGames/Mobile/Car Paint Low Detail Ref Mask" {
   Properties {
...
void main ()
{
  ...
  lowp vec4 tmpvar_17;
  tmpvar_17.w = 1.0;
  tmpvar_17.xyz = ((tmpvar_4.xyz * clamp ((ambientLighting + tmpvar_7), 0.0, 1.0)) + specularReflection);
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 46 to 46, TEX: 2 to 2
//   d3d9 - ALU: 52 to 52, TEX: 2 to 2
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
...
max_pp r2.x, r2, c11.z
abs_pp r1.x, r1
max_pp r0.x, r0, c11.z
mov_pp r2.w, c11.y
texld r4, r5, s1
pow_pp r5.w, r2.x, c6.x
mov_pp r2.x, r5.w
mov_pp r5.xyz, c10
mul_pp r5.xyz, c5, r5
...
mov_pp r0.w, r4
mad_pp r2, r0, r3.w, r2
mul_pp r0, r1.x, r0
mad_pp r0, r0, r3.w, r2
mov_pp oC0, r0
"
}
