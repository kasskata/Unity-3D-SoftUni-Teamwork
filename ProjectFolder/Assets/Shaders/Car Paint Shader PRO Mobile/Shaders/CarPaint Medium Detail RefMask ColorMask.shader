...
Shader "RedDotGames/Mobile/Car Paint Medium Detail Ref Color Mask" {
   Properties {
...
void main ()
{
  ...
  lowp vec4 tmpvar_17;
  tmpvar_17.w = 1.0;
  tmpvar_17.xyz = (((tmpvar_4.xyz * mix (_Color.xyz, vec3(1.0, 1.0, 1.0), vec3((1.0 - tmpvar_4.w)))) * clamp (((xlv_TEXCOORD2 + ambientLighting) + tmpvar_7), 0.0, 1.0)) + specularReflection);
...
void main ()
{
  ...
  tmpvar_13 = ((attenuation * unity_LightColor[0].xyz) * tmpvar_12);
  ...
  tmpvar_19 = ((attenuation * unity_LightColor[1].xyz) * tmpvar_18);
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 59 to 59, TEX: 2 to 2
//   d3d9 - ALU: 63 to 63, TEX: 2 to 2
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
...
mov_pp r2.xyz, c3
add_pp r7.xyz, c11.y, -r2
add_pp r2.x, -r5.w, c11.y
mad_pp r2.xyz, r2.x, r7, c3
mul_pp r5.xyz, r5, r2
pow_pp r2.x, r1.x, c9.x
max_pp r1.x, r0, c11.z
mov_pp r0.x, r2.x
add_pp r7.xyz, t2, c0
mad_pp_sat r1.xyz, r3, r1.x, r7
