...
Shader "RedDotGames/Mobile/Car Paint Ultra Detail Alpha" {
   Properties {
...
void main ()
{
  ...
  color = tmpvar_25;
  color = ((color + reflTex) + (tmpvar_23 * reflTex));
  color.w = _Color.w;
  gl_FragData[0] = color;
}
...
void main ()
{
  ...
  lowp float tmpvar_21;
  tmpvar_21 = max (0.0, dot (tmpvar_11, normalize (vertexToLightSource)));
  ...
  tmpvar_27 = max (0.0, dot (tmpvar_11, normalize (vertexToLightSource)));
  ...
  tmpvar_33 = max (0.0, dot (tmpvar_11, normalize (vertexToLightSource)));
  ...
  tmpvar_39 = max (0.0, dot (tmpvar_11, normalize (vertexToLightSource)));
...
MUL R0.xyz, R0, R1.w;
CMP R2.w, -R2, c[15], c[15].y;
CMP R2.xyz, -R2.w, R2, c[15].w;
MUL R4.xyz, R2, c[7].x;
...
dp3_pp r0.w, r1, v1
abs_pp_sat r0.x, r0.w
add_pp r1.w, -r0.x, c15.y
pow_pp r3, r1.w, c13.x
mul_pp r2.w, r0.y, r0.y
pow_pp r0, r2.w, c10.x
mul_pp r0.xyz, r0.x, c11
mad_pp r2.xyz, r0, c9.x, r2
mov_pp r0.w, r3.x
...
MUL R2.xyz, R3, -R0.w;
MUL R1.xyz, R1.w, R1;
MAD R2.xyz, -R2, c[15].x, -R4;
DP3 R1.y, R2, R1;
SLT R1.z, R0.w, c[15].w;
ABS R1.z, R1;
MAX R1.y, R1, c[15].w;
...
POW R1.y, R1.y, c[6].x;
MUL R2.xyz, R2, R1.y;
DP3 R1.y, R3, fragment.texcoord[4];
CMP R2.w, -R1.z, c[15], c[15].y;
MUL R3.xyz, R3, R1.y;
CMP R2.xyz, -R2.w, R2, c[15].w;
MAD R1.yzw, -R3.xxyz, c[15].x, fragment.texcoord[4].xxyz;
DP3 R2.w, R1.yzww, fragment.texcoord[1];
MUL R3.xyz, R2, c[7].x;
ABS_SAT R2.x, R2.w;
MAX R2.w, R0, c[15];
ADD R0.w, -R2.x, c[15].y;
MOV R2.xyz, c[3];
POW R0.w, R0.w, c[13].x;
MUL R0.xyz, R0, c[3];
MAD R2.xyz, R2, c[0], fragment.texcoord[2];
MAD_SAT R2.xyz, R0, R2.w, R2;
MUL R0.w, R0, c[12].x;
TEX R0.xyz, fragment.texcoord[3], texture[0], 2D;
MAD R0.xyz, R0, R2, R3;
MAD R2.xyz, R4, c[9].x, R0;
ADD R2.w, R0, c[4].x;
MUL_SAT R1.x, R2.w, R1;
TEX R0.xyz, R1.yzww, texture[3], CUBE;
MUL R0.xyz, R0, R1.x;
ADD R1.xyz, R0, R2;
MAD result.color.xyz, R0.w, R0, R1;
MOV result.color.w, c[3];
...
texldp r2.x, v7, s1
mov_pp r2.y, r3.x
mul_pp r3.xyz, r2.x, c14
mul_pp r1.xyz, r3, c5
mul_pp r1.xyz, r1, r2.y
abs_pp r0.w, r0
cmp_pp r4.xyz, -r0.w, r1, c15.w
mov_pp r1.xyz, v6
mov_pp r2.yzw, v6.xxyz
mul_pp r1.xyz, v1.zxyw, r1.yzxw
mad_pp r1.xyz, v1.yzxw, r2.wyzw, -r1
mov r2.z, r1
mad_pp r5.xyz, r5, c16.x, c16.yyzw
mov r2.y, v6.z
mov r2.w, v5.z
dp3_pp r1.z, r2.yzww, -r5
mov r2.z, r1.x
mov r2.w, v5.x
mov r2.y, v6.x
dp3_pp r1.x, -r5, r2.yzww
mov r2.z, r1.y
mov r2.w, v5.y
mov r2.y, v6
dp3_pp r1.y, -r5, r2.yzww
dp3_pp r0.w, r1, r1
mul_pp r2.yzw, r4.xxyz, c7.x
mov_pp r4.xyz, c0
rsq_pp r0.w, r0.w
max_pp r1.w, r1, c15
mul_pp r3.xyz, r3, c3
mad_pp r4.xyz, c3, r4, v2
mad_pp_sat r4.xyz, r3, r1.w, r4
texld r3.xyz, v3, s0
mad_pp r3.xyz, r3, r4, r2.yzww
...
dp3_pp r0.w, r0, v1
mul_pp r1.x, r1, r1
pow_pp r4, r1.x, c10.x
abs_pp_sat r0.w, r0
add_pp r0.w, -r0, c15.y
pow_pp r1, r0.w, c13.x
mov_pp r0.w, r1.x
mul_pp r0.w, r0, c12.x
mov_pp r1.y, r4.x
