...
void main ()
{
  ...
  xlv_TEXCOORD1 = normalize ((tmpvar_9 * modelMatrixInverse).xyz);
...
void main ()
{
  ...
  modelMatrixInverse = (_World2Object);
  highp vec4 tmpvar_8;
  tmpvar_8 = (modelMatrix * _glesVertex);
  lowp vec4 tmpvar_9;
  tmpvar_9.w = 0.0;
  tmpvar_9.xyz = tmpvar_1;
  ...
  lowp vec3 tmpvar_12;
  tmpvar_12 = normalize ((tmpvar_11 * modelMatrixInverse).xyz);
  ...
  tmpvar_21 = max (0.0, dot (tmpvar_12, normalize (vertexToLightSource)));
  ...
  tmpvar_27 = max (0.0, dot (tmpvar_12, normalize (vertexToLightSource)));
  ...
  tmpvar_33 = max (0.0, dot (tmpvar_12, normalize (vertexToLightSource)));
  ...
  tmpvar_39 = max (0.0, dot (tmpvar_12, normalize (vertexToLightSource)));
...
void main ()
{
  ...
  tmpvar_4.zw = ((_glesMultiTexCoord1.xy * unity_LightmapST.xy) + unity_LightmapST.zw);
  highp vec4 tmpvar_13;
  tmpvar_13 = (gl_ModelViewProjectionMatrix * _glesVertex);
  highp vec4 tmpvar_14;
  tmpvar_14.w = 1.0;
  tmpvar_14.xyz = _WorldSpaceCameraPos;
  highp vec3 tmpvar_15;
  tmpvar_15 = normalize (((modelMatrix * _glesVertex) - tmpvar_14).xyz);
  tmpvar_5 = tmpvar_15;
  highp vec4 tmpvar_16;
  tmpvar_16.w = 0.0;
  tmpvar_16.xyz = tmpvar_2.xyz;
  highp vec3 tmpvar_17;
  tmpvar_17 = normalize ((modelMatrix * tmpvar_16).xyz);
  tmpvar_7 = tmpvar_17;
  ...
  lowp float tmpvar_22;
  tmpvar_22 = max (0.0, dot (tmpvar_12, normalize (vertexToLightSource)));
  ...
  tmpvar_28 = max (0.0, dot (tmpvar_12, normalize (vertexToLightSource)));
  ...
  tmpvar_34 = max (0.0, dot (tmpvar_12, normalize (vertexToLightSource)));
  ...
  tmpvar_40 = max (0.0, dot (tmpvar_12, normalize (vertexToLightSource)));
