...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 49 to 49, TEX: 2 to 2
//   d3d9 - ALU: 54 to 54, TEX: 2 to 2
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
...
mov_pp r2.w, c11.y
texld r4, r5, s1
pow_pp r5.w, r1.x, c6.x
add_pp r1.x, -r2, c11.y
pow_pp r6.w, r1.x, c9.x
...
abs_pp r1.x, r1
cmp_pp r1.xyz, -r1.x, r2, c11.z
mov_pp r2.xyz, c3
mul_pp r5.xyz, r1, c7.x
mov_pp r1.x, r6.w
add_pp r6.xyz, c11.y, -r2
add_pp r2.x, -r3.w, c11.y
