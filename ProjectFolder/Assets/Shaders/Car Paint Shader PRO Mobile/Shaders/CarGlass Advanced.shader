...
void main ()
{
  ...
  tmpvar_10 = ((((reflcol.xyz * _ReflectColor.xyz) * _TintColor.xyz) * (1.0 - tex.w)) + (tex * _Color).xyz);
  tmpvar_4 = tmpvar_10;
  mediump float tmpvar_11;
  tmpvar_11 = max (tex.w, clamp ((refl2Refr * _AlphaPower), 0.0, 1.0));
  tmpvar_5 = tmpvar_11;
  lowp vec4 c_i0_i1;
...
Program "fp" {
// Fragment combos: 3
//   opengl - ALU: 26 to 28, TEX: 2 to 3
//   d3d9 - ALU: 27 to 29, TEX: 2 to 3
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" }
...
DP3 R1.w, R2, R3;
MAX R1.w, R1, c[7].x;
ADD_SAT R1.w, -R1, c[7].y;
POW R1.w, R1.w, c[6].x;
MAD R1.w, R1, c[7].z, c[7];
MAX R1.w, R1, c[7].x;
...
MAD R1.xyz, R1, c[8].y, R2;
MAD result.color.xyz, R0, c[8].x, R1;
MAX result.color.w, R0, R1;
END
...
dcl_2d s0
dcl_cube s1
def c7, 0.00000000, 1.00000000, 0.79638672, 0.20373535
def c8, 2.00000000, 0.25000000, 0, 0
dcl t0.xy
dcl t1.xyz
dcl t2.xyz
dcl t3.xyz
...
dp3_pp r2.x, r3, r2
max_pp r2.x, r2, c7
add_pp r3.x, -r0.w, c7.y
add_pp_sat r2.x, -r2, c7.y
mul_pp r1.xyz, r1, c3
mul_pp r0.xyz, r0, c2
mad_pp r0.xyz, r1, r3.x, r0
pow_pp r1.y, r2.x, c6.x
dp3_pp r3.x, t3, c0
mad_pp r1.x, r1.y, c7.z, c7.w
max_pp r1.x, r1, c7
mul_pp_sat r1.x, r1, c5
mul_pp r2.xyz, r0, c1
max_pp r3.x, r3, c7
mul_pp r2.xyz, r3.x, r2
mul_pp r3.xyz, r0, t4
mad_pp r2.xyz, r2, c8.x, r3
mad_pp r0.xyz, r0, c8.y, r2
max_pp r0.w, r0, r1.x
mov_pp oC0, r0
"
}
...
adaaaaaaadaaahacadaaaaaaacaaaaaaacaaaaoeaeaaaaaa mul r3.xyz, r3.x, v2
...
abaaaaaaadaaabacabaaaappacaaaaaaahaaaaffabaaaaaa add r3.x, r1.w, c7.y
...
alaaaaaaabaaapacacaaaaaaacaaaaaaagaaaaaaabaaaaaa pow r1, r2.x, c6.x
bcaaaaaaadaaabacadaaaaoeaeaaaaaaaaaaaaoeabaaaaaa dp3 r3.x, v3, c0
...
ahaaaaaaadaaabacadaaaaaaacaaaaaaahaaaaoeabaaaaaa max r3.x, r3.x, c7
adaaaaaaacaaahacadaaaaaaacaaaaaaacaaaakeacaaaaaa mul r2.xyz, r3.x, r2.xyzz
adaaaaaaadaaahacaaaaaakeacaaaaaaaeaaaaoeaeaaaaaa mul r3.xyz, r0.xyzz, v4
adaaaaaaacaaahacacaaaakeacaaaaaaaiaaaaaaabaaaaaa mul r2.xyz, r2.xyzz, c8.x
abaaaaaaacaaahacacaaaakeacaaaaaaadaaaakeacaaaaaa add r2.xyz, r2.xyzz, r3.xyzz
adaaaaaaaaaaahacaaaaaakeacaaaaaaaiaaaaffabaaaaaa mul r0.xyz, r0.xyzz, c8.y
abaaaaaaaaaaahacaaaaaakeacaaaaaaacaaaakeacaaaaaa add r0.xyz, r0.xyzz, r2.xyzz
ahaaaaaaaaaaaiacaaaaaappacaaaaaaabaaaaaaacaaaaaa max r0.w, r0.w, r1.x
...
DP3 R2.w, R3, R4;
MAX R2.w, R2, c[5].x;
ADD_SAT R2.w, -R2, c[5].y;
MUL R1.xyz, R1.w, R1;
POW R2.w, R2.w, c[4].x;
ADD R3.x, -R0.w, c[5].y;
MUL R0.xyz, R0, c[0];
MAD R0.xyz, R2, R3.x, R0;
MAD R2.x, R2.w, c[5].z, c[5].w;
MAX R1.w, R2.x, c[5].x;
MUL R1.xyz, R1, R0;
MUL R2.xyz, R0, c[6].y;
MUL_SAT R0.x, R1.w, c[3];
MAD result.color.xyz, R1, c[6].x, R2;
MAX result.color.w, R0, R0.x;
END
...
adaaaaaaaeaaahacaeaaaaaaacaaaaaaadaaaaoeaeaaaaaa mul r4.xyz, r4.x, v3
...
adaaaaaaaaaaahacadaaaakeacaaaaaaacaaaaoeabaaaaaa mul r0.xyz, r3.xyzz, c2
...
abaaaaaaaaaaabacaaaaaappacaaaaaaafaaaaffabaaaaaa add r0.x, r0.w, c5.y
...
ahaaaaaaaaaaabacaaaaaaaaacaaaaaaafaaaaoeabaaaaaa max r0.x, r0.x, c5
adaaaaaaacaaahacacaaaakeacaaaaaaagaaaaaaabaaaaaa mul r2.xyz, r2.xyzz, c6.x
adaaaaaaaaaaabacaaaaaaaaacaaaaaaadaaaaoeabaaaaaa mul r0.x, r0.x, c3
bgaaaaaaaaaaabacaaaaaaaaacaaaaaaaaaaaaaaaaaaaaaa sat r0.x, r0.x
adaaaaaaabaaahacabaaaakeacaaaaaaagaaaaffabaaaaaa mul r1.xyz, r1.xyzz, c6.y
abaaaaaaabaaahacabaaaakeacaaaaaaacaaaakeacaaaaaa add r1.xyz, r1.xyzz, r2.xyzz
ahaaaaaaabaaaiacacaaaappacaaaaaaaaaaaaaaacaaaaaa max r1.w, r2.w, r0.x
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 27 to 38, TEX: 2 to 4
//   d3d9 - ALU: 29 to 39, TEX: 2 to 4
SubProgram "opengl " {
Keywords { "POINT" }
...
DP3 R1.y, fragment.texcoord[3], R1;
...
abaaaaaaabaaabacadaaaappacaaaaaaagaaaaffabaaaaaa add r1.x, r3.w, c6.y
...
MUL R0.xyz, R0, c[1];
MAD R0.xyz, R1, R2.x, R0;
ADD_SAT R1.x, -R1.w, c[6].z;
POW R1.w, R1.x, c[5].x;
MOV R1.xyz, fragment.texcoord[4];
DP3 R1.y, fragment.texcoord[3], R1;
MAD R1.w, R1, c[6].y, c[6].x;
MUL R0.xyz, R0, c[0];
MAX R1.y, R1, c[6].w;
MUL R2.xyz, R1.y, R0;
MAX R1.x, R1.w, c[6].w;
...
bcaaaaaaadaaabacadaaaaoeaeaaaaaaadaaaaoeaeaaaaaa dp3 r3.x, v3, v3
bcaaaaaaaaaaabacacaaaaoeaeaaaaaaacaaaaoeaeaaaaaa dp3 r0.x, v2, v2
akaaaaaaadaaabacadaaaaaaacaaaaaaaaaaaaaaaaaaaaaa rsq r3.x, r3.x
akaaaaaaaaaaabacaaaaaaaaacaaaaaaaaaaaaaaaaaaaaaa rsq r0.x, r0.x
adaaaaaaaaaaahacaaaaaaaaacaaaaaaacaaaaoeaeaaaaaa mul r0.xyz, r0.x, v2
...
bgaaaaaaaaaaabacaaaaaaaaacaaaaaaaaaaaaaaaaaaaaaa sat r0.x, r0.x
alaaaaaaadaaapacaaaaaaaaacaaaaaaafaaaaaaabaaaaaa pow r3, r0.x, c5.x
adaaaaaaaaaaahacacaaaakeacaaaaaaadaaaaoeabaaaaaa mul r0.xyz, r2.xyzz, c3
...
bfaaaaaaaaaaaiacabaaaappacaaaaaaaaaaaaaaaaaaaaaa neg r0.w, r1.w
abaaaaaaaaaaabacaaaaaappacaaaaaaagaaaaffabaaaaaa add r0.x, r0.w, c6.y
...
bgaaaaaaaaaaabacaaaaaaaaacaaaaaaaaaaaaaaaaaaaaaa sat r0.x, r0.x
adaaaaaaabaaahacabaaaakeacaaaaaaahaaaaaaabaaaaaa mul r1.xyz, r1.xyzz, c7.x
ahaaaaaaabaaaiacabaaaappacaaaaaaaaaaaaaaacaaaaaa max r1.w, r1.w, r0.x
aaaaaaaaaaaaapadabaaaaoeacaaaaaaaaaaaaaaaaaaaaaa mov o0, r1
"
}
...
MAD R1.xy, fragment.texcoord[5], R0.x, c[7].x;
...
MUL R0.xyz, R0, c[3];
MUL R3.xyz, R1.y, fragment.texcoord[3];
RSQ R1.x, R1.x;
...
ADD_SAT R1.x, -R1, c[6].z;
POW R1.x, R1.x, c[5].x;
MAD R2.x, R1, c[6].y, c[6];
DP3 R1.y, fragment.texcoord[4], fragment.texcoord[4];
RSQ R1.y, R1.y;
MUL R1.xyz, R1.y, fragment.texcoord[4];
DP3 R1.x, fragment.texcoord[3], R1;
SLT R1.y, c[6].w, fragment.texcoord[5].z;
MUL R0.w, R1.y, R0;
MUL R1.y, R0.w, R1.w;
MAX R0.w, R1.x, c[6];
MUL R0.xyz, R0, c[0];
...
dcl_2d s3
def c6, 0.00000000, 1.00000000, 0.79638672, 0.20373535
def c7, 0.50000000, 2.00000000, 0, 0
dcl t0.xy
dcl t1.xyz
dcl t2.xyz
dcl t3.xyz
...
abaaaaaaabaaadacabaaaafeacaaaaaaahaaaaaaabaaaaaa add r1.xy, r1.xyyy, c7.x
...
adaaaaaaaaaaabacaaaaaaaaacaaaaaaaeaaaaoeabaaaaaa mul r0.x, r0.x, c4
bgaaaaaaaaaaabacaaaaaaaaacaaaaaaaaaaaaaaaaaaaaaa sat r0.x, r0.x
bfaaaaaaaeaaabacafaaaakkaeaaaaaaaaaaaaaaaaaaaaaa neg r4.x, v5.z
ckaaaaaaabaaabacaeaaaaaaacaaaaaaahaaaakkabaaaaaa slt r1.x, r4.x, c7.z
...
bfaaaaaaadaaaiacacaaaappacaaaaaaaaaaaaaaaaaaaaaa neg r3.w, r2.w
abaaaaaaaaaaabacadaaaappacaaaaaaagaaaaffabaaaaaa add r0.x, r3.w, c6.y
...
bgaaaaaaaaaaabacaaaaaaaaacaaaaaaaaaaaaaaaaaaaaaa sat r0.x, r0.x
adaaaaaaacaaahacacaaaakeacaaaaaaaaaaaaoeabaaaaaa mul r2.xyz, r2.xyzz, c0
adaaaaaaadaaabacaeaaaappacaaaaaaaaaaaappacaaaaaa mul r3.x, r4.w, r0.w
ahaaaaaaabaaabacabaaaaaaacaaaaaaagaaaaoeabaaaaaa max r1.x, r1.x, c6
